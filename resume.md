...
- 趣味: 読書、散歩
- 資格: JSTQB Foundation Label、学芸員資格

## 職務経歴

| 所属 | 期間 | 業務内容 |
| - | - | - |
| [株式会社HACARUS](https://hacarus.com/ja/) | 2020/09 - 現在 | QAエンジニア |
...
- 一人目QAエンジニア。JSTQBシラバスに則ったテストプロセスを構築後、外観検査アプリケーションのプロジェクトにジョイン。アジャイル開発におけるQAサイクルの回し方をまだまだ模索中。
